...
<div class="mb-4">
    ...
    <h1 class="h2 font-heading mt-2" style="color: var(--text-primary);">Tambah Pengguna Baru</h1>
    <span class="text-muted small">Daftarkan akun anggota baru ke dalam sistem</span>
</div>
...
<div class="row">
    <div class="col-md-8">
        <div class="glass-card p-4">
            ...
            <form action="index.php?controller=user&action=add" method="POST" autocomplete="off">
                <!-- CSRF Token -->
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= isset($errors['full_name']) ? 'is-invalid' : '' ?>" id="full_name" name="full_name" value="<?= htmlspecialchars($_POST['full_name'] ?? '') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= isset($errors['nim_nip']) ? 'is-invalid' : '' ?>" id="nim_nip" name="nim_nip" value="<?= htmlspecialchars($_POST['nim_nip'] ?? '') ?>" required>
                ...
                <div class="mb-3">
                    <label for="password" class="form-label text-muted small">Kata Sandi Awal <span class="text-danger">*</span></label>
                    <input type="password" class="form-control <?= isset($errors['password']) ? 'is-invalid' : '' ?>" id="password" name="password" required>
                    <div class="form-text text-muted small" style="font-size: 0.75rem;">Kata sandi minimal 8 karakter. Pengguna dapat merubahnya di profil nanti.</div>
