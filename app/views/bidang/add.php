...
<div class="mb-4">
    ...
    <h1 class="h2 font-heading mt-2" style="color: var(--text-primary);">Tambah Bidang Barang</h1>
    <span class="text-muted small">Buat bidang/unit penanggung jawab inventaris baru</span>
</div>
...
<div class="row">
    <div class="col-md-8">
        <div class="glass-card p-4">
            ...
            <form action="index.php?controller=bidang&action=add" method="POST" autocomplete="off">
                <!-- CSRF Token -->
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= isset($errors['nama_bidang']) ? 'is-invalid' : '' ?>" id="nama_bidang" name="nama_bidang" value="<?= htmlspecialchars($_POST['nama_bidang'] ?? '') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= isset($errors['penanggung_jawab']) ? 'is-invalid' : '' ?>" id="penanggung_jawab" name="penanggung_jawab" value="<?= htmlspecialchars($_POST['penanggung_jawab'] ?? '') ?>" placeholder="Sersan Mayor Logistik" required>
                ...
                <div class="d-flex gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Simpan Bidang</button>
                </div>
            </form>
        </div>
    </div>
